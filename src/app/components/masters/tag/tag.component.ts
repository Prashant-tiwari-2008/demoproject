...
export class TagComponent implements OnInit , OnDestroy {
  ...
  onSubmit() {
    ...
    switch (this.dbops) {
      case DbOperation.create:
        this._dataService.post(Global.BASE_APT_PATH + "TagMaster/Save/", this.addForm.value).subscribe(res => {
          if (res.isSuccess) {
            this.getData();
      ...
      case DbOperation.update:
        this._dataService.post(Global.BASE_APT_PATH + "TagMaster/Update/", this.addForm.value).subscribe(res => {
          if (res.isSuccess) {
            this.getData();
  ...
  Delete(Id: number) {
    ...
    this._dataService.post(Global.BASE_APT_PATH + "TagMaster/Delete/", obj).subscribe(res => {
      if (res.isSuccess) {
        this.getData();
